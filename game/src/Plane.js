...
class Plane{
    ...
    load(){
		...
		loader.load(
			...
			gltf => {
                ...
                // this.plane.rotation.x = xRotation;
    ...
    reset(){
        this.plane.position.set(xRotation, 0, 0);
    ...
    update(time){
        ...
        if (this.game.active){
            ...
            this.plane.rotation.set(xRotation, 0, 0, 'XYZ');
