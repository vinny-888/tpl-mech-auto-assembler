    ...
    RARITY_ORDER.forEach((model)=>{
        STYLE_ORDER[model].forEach((style)=>{
            if(dataModel.modelParts[model] && dataModel.modelParts[model]['Engine'] && dataModel.modelParts[model]['Engine'][style]){
                ...
                // let partCount = getMostPartsStyles(dataModel.modelParts[model]);
...
function buildSameModelMechsStyles(afterglowRequired, allowPartial, allowNoModel){
    let mixedMechs = {};
    RARITY_ORDER.forEach((model)=>{
...
function buildMixedModelMechsStyles(afterglowRequired, allowPartial, allowNoModel){
    let mixedMechs = {};
    let mixedMech = {};
    let hasEngine = false;
